...
def main():
    ...
    questions_menu.place(x=698,y=210,width=270,height=30)
    

    questions_menu["menu"].config(bg="GRAY",fg="white",font="time 12 bold")
    questions_menu.config(bg = "GRAY", fg="white",font="time 10 bold")  # Set background color to green


    #answer entry
    answer_entry=Entry(root)
    answer_entry.place(x=698,y=250,width=190,height=25)
    answer_entry.config(bg="GRAY" ,fg="white",font="time 12 bold")

    #button submit
    button_submit=Button(root,text="Submit",fg="white",font="time 12 bold",padx=20,pady=30)
    button_submit.place(x=750,y=290,width=90,height=40)
    button_submit.config(bg="GRAY")
    root.mainloop()               
